...
const ProductCard: FC<ProductCardProps> = ({
  ...
  return (
    <Link
      to={`product/${id}`}
      className="w-58 bg-white border border-black hover:shadow-[6px_6px_0px_#000] shadow-none hover:translate-0.5 duration-200 p-3.5 font-sans flex flex-col"
    >
      {/* Image Container */}
      ...
      <div className="mt-2 flex flex-col w-full">
        ...
        <h3 className="text-[12px] text-black leading-tight truncate w-full" title={isbn}>
          ISBN: {isbn}
        </h3>
